...
export default function Locacao({modoBranco}: Props){
    ...
    function addImovelLocacao(){
        ...
        if(valorAluguelAdd && valorCondominioAdd && jurosAdd && acrescimosAdd && tipoAluguelAdd && tipoOutroAdd && condominioEmbutidoAdd !== undefined && regimeOutroAdd && quantidadeAdd){
    ...
    return (
        <div className="flex flex-col gap-2">
            <div className="flex flex-col gap-2">
                <div className="flex flex-col  gap-2 border-2 border-solid  self-start py-5 px-12">
                    ...
                    {/*                    <div className="flex flex-col" >
                        ...
                        <div className="flex flex-col gap-1 bg-[#222222] p-4 rounded-md">
                            ...
                            <input value={quantidadeTela} className="ml-6 outline-none rounded-md border-2 border-solid border-gray-300 p-1 w-28" type="number" id="acrescimos" onChange={(e) => mudarQuantidade(e)}/>
                        </div>
                </div>


                    <div className="self-end">
                        <BotaoGeral principalBranco={true} onClickFn={addImovelLocacao} text="Adicionar"/>
                    </div>
                </div>
            </div>
