...
export default function BensMoveisBotao({objIsChecked, setObjIsChecked}: Props){


      function handleToggle(){
        if(objIsChecked.isCheckedMoveis){
            const objIsCheckedClone = {...objIsChecked}
            objIsCheckedClone.isCheckedMoveis = false
            setObjIsChecked(objIsCheckedClone)
        }else{
            const objIsCheckedClone = {...objIsChecked}
            objIsCheckedClone.isCheckedMoveis = true
            ...
            <div className='flex flex-col gap-2  justify-between h-full'>     
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='opacity-70'>
                        Insira os valores de locação de bens móveis e veja como IBS e CBS afetam os contratos, pagos ou recebidos.
                    </div>
                </div>
                <div className='self-end'>
                    <SetaNao condicaoNao={objIsChecked.isCheckedMoveis}  />
                </div>
            </div>
